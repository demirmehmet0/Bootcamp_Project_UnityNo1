...
public class KamerayaOdaklanarak : MonoBehaviour
{
    ...
    float radius = 1.5f;// i will try different numbers for radius to optimize the rotation of the earth
    ...
    Vector3 getSphericalCoordinates(Vector3 cartesian) // i used formulas from electromagnetic
    {
        float r = Mathf.Sqrt(
